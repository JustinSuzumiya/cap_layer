...
//#define PBLKS_PER_BANK	((_PBLKS_PER_BANK + SPARE_PBLKS_PER_BANK) / 3) // 20GB
#define PBLKS_PER_BANK	(3000) //40G
//#define PBLKS_PER_BANK	((DISK_SIZE<<10) * (100 + OVER_PROVISION) * NUM_PLANES * 129 / 100 / NUM_BANKS / (BYTES_PER_VBLK>>20) / 128 + 100)

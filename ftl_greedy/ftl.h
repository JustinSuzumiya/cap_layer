...
+ BAD_BLK_BMP_BYTES + PAGE_MAP_BYTES + INVERSE_PAGE_MAP_BYTES + VCOUNT_BYTES + LRU_BYTES + HASH_TABLE_BYTES\
...
+ LPN_LIST_OF_CUR_VBLOCK_BYTES + LPN_LIST_OF_GC_VBLOCK_BYTES + TIMESTAMP_BYTES)
...
#define INVERSE_PAGE_MAP_ADDR	(PAGE_MAP_ADDR + PAGE_MAP_BYTES)
#define INVERSE_PAGE_MAP_BYTES	((NUM_VPAGES * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define VCOUNT_ADDR			(INVERSE_PAGE_MAP_ADDR + INVERSE_PAGE_MAP_BYTES)
...
#define LPN_LIST_OF_CUR_VBLOCK_BYTES (sizeof(UINT32) * PAGES_PER_BLK * NUM_BANKS)

#define LPN_LIST_OF_GC_VBLOCK_ADDR (LPN_LIST_OF_CUR_VBLOCK_ADDR + LPN_LIST_OF_CUR_VBLOCK_BYTES)
#define LPN_LIST_OF_GC_VBLOCK_BYTES (sizeof(UINT32) * PAGES_PER_BLK * NUM_BANKS)

#define TIMESTAMP_ADDR	(LPN_LIST_OF_GC_VBLOCK_ADDR + LPN_LIST_OF_GC_VBLOCK_BYTES)
#define TIMESTAMP_BYTES	(sizeof(UINT32) * (32) * 2048)
/*

...
+ P_SRC_VBLOCK_BYTES + P_SRC_PAGE_BYTES + P_DST_VBLOCK_BYTES + P_DST_PAGE_BYTES + P_NEXT_NODE_BYTES + P_PREV_NODE_BYTES + P_ISSUE_FLAG_BYTES + P_LPN_BYTES + P_ID_BYTES + P_BANK_STATE_BYTES + LPN_LIST_OF_GC_VBLOCK_BYTES)
...
#define LPN_LIST_OF_GC_VBLOCK_ADDR (P_BANK_STATE_ADDR + P_BANK_STATE_BYTES)
